...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          // shrink-0 keeps the sidebar at its own width instead of being
          // squeezed by wide page content next to it.
          ...
          <div className="relative pr-4.5">
            ...
            >
              <div className="size-10 rounded-xl overflow-hidden flex items-center justify-center shrink-0">
                <img
                  src="/logo.png"
                  alt="Telkomsel AI Logo"
                  className="size-full object-cover"
                />
              </div>
              <div className="flex flex-col">
                <span className="text-base font-bold text-white leading-tight m-0">
                  Telkomsel AI
                </span>
                <span
